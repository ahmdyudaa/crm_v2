...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>public/flash.css">
</head>
    ...
    <script>
        ...
        $(document).ready(function() {
            if(localStorage.getItem('lastVisitedPage')) {
                ...
                // changeURL(lastVisitedPage);
                addActiveMenu(lastVisitedPage);
            } else {
                loadPage('dashboard'); 
                addActiveMenu('dashboard');
            }

            // Ketika pengguna mengklik menu
        ...
        function loadPage(page) {
            $.ajax({
                url: '<?php echo site_url('admin/'); ?>' + page,
                method: 'GET',
